...
public sealed class AliasResolver
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
        "Design",
        "MA0002",
        Justification = "JsonSerializer.Deserialize does not accept a comparer"
    )]
    public static AliasResolver LoadFromFile(string path)
    {
        ...
        var parsed =
            JsonSerializer.Deserialize<Dictionary<string, Dictionary<string, string>>>(raw)
