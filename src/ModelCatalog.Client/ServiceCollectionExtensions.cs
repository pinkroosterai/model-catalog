...
{
    public static IServiceCollection AddModelCatalogClient(
    ...
    )
    {
        ...
        services.TryAddSingleton<IDistributedCache>(_ => new MemoryDistributedCache(
        ...
        services
            .AddHttpClient<IModelCatalogClient, ModelCatalogClient>(
                (sp, c) =>
                {
